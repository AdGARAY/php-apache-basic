...
RUN echo 'xdebug.dump_globals = on' >> /usr/local/etc/php/php.ini
RUN echo 'xdebug.dump.SERVER = REQUEST_URI' >> /usr/local/etc/php/php.ini
RUN echo 'xdebug.show_local_vars = on' >> /usr/local/etc/php/php.ini
RUN echo "xdebug.cli_color = 1" >> /usr/local/etc/php/php.ini
RUN echo chmod 666 /usr/local/etc/php/php.ini
